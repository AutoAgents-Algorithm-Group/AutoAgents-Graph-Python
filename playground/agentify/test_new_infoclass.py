...
def main():
    ...
    # 添加连接边
    workflow.add_edge(START, "infoclass1", "finish", "switchAny")
    workflow.add_edge(START, "infoclass1", "userChatInput", "text")
    
    workflow.add_edge("infoclass1", "buyVeg", list(labels.keys())[0], "text")
    workflow.add_edge("infoclass1", "buyMeat", list(labels.keys())[1], "text")
